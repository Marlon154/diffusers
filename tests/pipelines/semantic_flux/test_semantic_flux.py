...
from diffusers import SemanticFluxPipeline as FluxPipeline
...
class FluxPipelineFastTests(unittest.TestCase, PipelineTesterMixin):
    ...
    def get_dummy_inputs(self, device, seed=0):
        ...
        inputs = {
            ...
            # "editing_prompt": ["burger"],
            "editing_prompt": ["burger", "pizza"],
    ...
    def test_flux_prompt_embeds(self):
        ...
        (prompt_embeds, pooled_prompt_embeds, text_ids, editing_prompt_embeds, pooled_editing_prompt) = pipe.encode_prompt(
            prompt,
            prompt_2=None,
            device=torch_device,
        ...
        output_with_embeds = pipe(
            ...
            pooled_editing_prompt_embeds=pooled_editing_prompt,
            **inputs,
        ).images[0]
